...
export function Settings() {
  ...
  const [settingsTab, setSettingsTab] = useState<"workshop" | "catalogue" | "users" | "notifications" | "security">("workshop");
    ...
    <div className="flex flex-col min-h-screen">
      <div className="flex-1 space-y-4 lg:space-y-6">
        ...
        <Tabs value={settingsTab} onValueChange={(v) => setSettingsTab(v as typeof settingsTab)} className="space-y-8">
          ...
          {/* Workshop Settings - layout matches reference: only Business Profile + Save */}
          <TabsContent value="workshop">
            <div className="space-y-6">
              {/* Business Profile - only section visible by default (like reference) */}
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500 mt-0.5">Manage your workshop details and information</p>
                    </div>
                  </div>
                </CardHeader>
              ...
              {/* Additional workshop settings - Tax & Branding (below the fold) */}
              <TooltipProvider>
                ...
                <Card className="border-slate-200 shadow-sm rounded-2xl overflow-hidden bg-white">
                  <CardContent className="p-8">
                      ...
                      <div className="space-y-3">
                        ...
                        <Input 
                          ...
                          onChange={(e) => {
                            ...
                            // Allow empty string temporarily, convert to 0 only on blur if needed
                            if (val === "") {
                              setTaxRateCash(0);
                            } else {
                              const numVal = Number(val);
                              if (!isNaN(numVal) && numVal >= 0 && numVal <= 100) {
                                setTaxRateCash(numVal);
                              }
                            }
                          }}
                          onFocus={(e) => {
                    ...
                    <div className="flex justify-end pt-6 border-t border-slate-100 relative">
                      <Button 
                      ...
                      {taxSaveSuccess && (
                        <div className="absolute -top-12 right-0 bg-green-500 text-white px-5 py-1.5 rounded-full text-xs font-bold shadow-lg animate-in fade-in slide-in-from-bottom-2 whitespace-nowrap">
