...
export function Products() {
  const { products, addProduct, updateProduct, vendors, getVendorById } = useData();
  ...
  // Helper function to get vendor name from vendorId
          ...
          <Card key={product.id} className="p-4 border-slate-200 hover:border-theme-200 transition-colors">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div>
                ...
                <p className="font-semibold text-slate-900">{getVendorName(product.vendorId)}</p>
              </div>
            </div>
          </Card>
        ))}
